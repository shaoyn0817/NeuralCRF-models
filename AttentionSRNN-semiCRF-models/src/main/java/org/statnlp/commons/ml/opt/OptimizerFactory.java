...
public abstract class OptimizerFactory implements Serializable {
	...
	public static GradientDescentOptimizerFactory getGradientDescentFactoryUsingAdaDelta(){
		//BestParamCriteria.BEST_ON_DEV
		return new GradientDescentOptimizerFactory(BestParamCriteria.BEST_ON_DEV, AdaptiveStrategy.ADADELTA, 0.0, DEFAULT_ADADELTA_PHI, DEFAULT_ADADELTA_EPS);
	}
